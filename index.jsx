...
const PaymentMethodPicker=({value,onChange,payPhone,totalAmount})=>{
  const detected = payPhone ? detectNetwork(payPhone) : null;
            ...
            {payStatus==="idle"&&(
              <>
                <div style={{marginBottom:16}}>
                  ...
                  <Input label="Payment Phone Number" value={payPhone||form.phone}
    ...
    <ErrorBoundary>
      ...
      {isPublic&&(
        <>
          ...
          {page==="home"     &&<HomePage      setPage={handleSetPage} setPreselectedTrip={setPreselectedTrip} store={store} onCustomerLogin={()=>setShowCustomerAuth(true)} onStaffLogin={()=>setPage("login")} currentUser={currentUser}/>}
