      ...
      <footer style={{background:C.navy,borderTop:`1px solid rgba(255,255,255,0.1)`,padding:"44px 20px 20px"}}>
        <div style={{maxWidth:1200,margin:"0 auto"}}>
          <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fill,minmax(170px,1fr))",gap:32,marginBottom:36}}>
            <div>
              <div className="playfair" style={{fontWeight:800,fontSize:18,color:C.textPrimary,marginBottom:12}}>Raylane<span style={{color:C.amberLight}}>Express</span></div>
            ...
            {payStatus==="idle"&&(
              <>
                {(payMethod==="mtn"||payMethod==="airtel")&&(
                  <div style={{background:C.navyLight,borderRadius:10,padding:14,marginBottom:14,fontSize:12,color:C.textMuted}}>
                    <div style={{fontWeight:700,color:C.textPrimary,marginBottom:6}}>Payment Instructions:</div>
